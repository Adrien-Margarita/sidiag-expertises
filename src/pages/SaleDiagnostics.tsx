...
export default function SaleDiagnostics() {
  const diagnosticsVente = diagnostics.filter((d) =>
    ...
    <main className="mt-16">
      ...
      <section className="relative" role="banner">
        <img
          ...
          alt="Diagnostics immobiliers obligatoires à la vente à Toulon et dans le Var"
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <h1 className="text-3xl md:text-5xl text-white font-bold text-center px-4">
            Diagnostics immobiliers obligatoires pour la vente à Toulon, La Seyne‑sur‑Mer et dans le Var
          </h1>
        </div>
      </section>
      ...
      <section className="px-6 py-12 max-w-5xl mx-auto space-y-6">
        <p>
          Pour vendre votre bien immobilier à <strong>Toulon</strong>, <strong>La Seyne‑sur‑Mer</strong>, <strong>La Garde</strong>,
          ...
          vous devez fournir des <strong>diagnostics immobiliers obligatoires</strong>. Ces expertises garantissent la sécurité, la transparence et la conformité de votre transaction.
        </p>
      ...
      <section className="bg-gray-50 py-12" aria-labelledby="diagnostics-title">
        <div className="px-6 max-w-6xl mx-auto">
          ...
          >
            Quels diagnostics obligatoires pour vendre votre bien ?
          </h2>

          <div className="grid md:grid-cols-2 gap-8" role="list">
            {diagnosticsVente.map((diag) => (
              <Link
      ...
      <section className="px-6 py-12 max-w-5xl mx-auto space-y-6">
        ...
        <p>
          Nos <strong>diagnostics immobiliers vente</strong> sont réalisés dans les règles de l’art et dans les meilleurs délais, pour vous permettre de vendre votre bien en toute sérénité.
        </p>
      </section>
      ...
      >
        <div className="px-6 max-w-4xl mx-auto text-center space-y-4">
          <h2 id="why-choose-us" className="text-2xl font-bold">
            Pourquoi choisir Sidiag Expertises pour vos diagnostics vente ?
          </h2>
          <ul
      ...
      >
        <div className="text-center space-y-4">
          ...
          <p className="text-sm md:text-base">
            Obtenez votre devis gratuit pour vos diagnostics vente en quelques clics.
          </p>
          <Link
            to="/#devis"
